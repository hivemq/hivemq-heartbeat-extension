...
public class ConfigResolver implements Supplier<Path> {
     ...
     *
     * @param extensionHome        the extension home directory
     * @param extensionName        the name of the extension (for logging)
     * @param configLocation       the new config location relative to extension home (e.g., "conf/config.xml")
     * @param legacyConfigLocation the legacy config location relative to extension home (e.g., "extension-config.xml")
     */
